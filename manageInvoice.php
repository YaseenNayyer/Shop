...
<div class="col-md-12">
  <div class="container">
    ...
    <h2 style= "text-align:center; font-weight:900;">Customer Invoices</h2>
...
$sql="SELECT * FROM `invoice`  Limit $this_page_first_result,$result_per_page";
...
global $x;
  ...
  ?>
    ...
    <th><?php echo $res['invoice_no']; ?></th>       
      <th><?php  echo $res['TotalAmount'];?></th>
      ...
      <th><button class="btn-success btn" ><a href="viewinvoiceDetail.php?invoice_no=<?php echo $res['invoice_no']; ?>" class="text-white">Details</a></button></th>
      <th><button class="btn-success btn" ><a href="abpdf.php?invoice_no=<?php echo $res['invoice_no']; ?>" class="text-white">Print</a></button></th>
...
if($page>1)
 {
   ...
   <a href="manageinvoice.php?page='.($page-1).'" style="border:1px solid black;">Previous</a>
...
for($i=1;$i<=$number_of_pages;$i++)
{
  ...
  <a style="border:1px solid black;" href="manageinvoice.php?page='.$i.'" >'.$i.'</a>
...
if($i>$page)
 {
   ...
   <a href="manageinvoice.php?page='.($page+1).'"style="border:1px solid black;">Next</a>
