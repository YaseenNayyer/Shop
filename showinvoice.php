...
<ul class="dropdown-menu sub-down">
<li>
<a href="email.html">-Add</a>
</li>
<li><span class="badge badge-primary badge-pro float-right"></span>
<a href=#"calendar.html">-Manage</a>
</li>
...
<ul class="dropdown-menu sub-down">
<li>
<a href="alert.html">-Add</a>
</li>
<li>
<a href="badge.html">-Manage</a>
 </li>
...
while ($res=mysqli_fetch_array($result)) {
  ...
  ?>
    ...
    <tr class="text-center">
      ...
      <th><button class="btn-danger btn"><a class="delete_link" href="delete.php?invoice_no=<?php echo $res['invoice_no']; ?> " style="color:white;"  class="text-white">Delete</a></button></th>
      <th><button class="btn-success btn" ><a href="viewinvoiceDetail.php?invoice_no=<?php echo $res['invoice_no']; ?>" class="text-white">Update</a></button></th>
...
for($page=1;$page<=$number_of_pages;$page++)
{
  ...
  echo '<a href="showinvoice.php?page='.$page.'">' .$page. '</a>';
}
